"""
Main SOAPWeaver server implementation.

This module provides the core server functionality for converting web SOAP APIs
...
class SOAPWeaver:
    ...
    def __init__(self, name: str = "SOAPWeaver"):
    ...
    def _setup_core_tools(self):
        ...
        async def register_api(config: Dict[str, Any], ctx: Context) -> str:
            """
            Register a new SOAP API configuration and create MCP tools for its endpoints.
